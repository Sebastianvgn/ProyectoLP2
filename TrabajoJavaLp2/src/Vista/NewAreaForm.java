 ...
 * @author alulab14
 */
public class NewAreaForm extends javax.swing.JDialog {

    /**
     * Creates new form NewAreaForm
     */
    private DefaultTableModel modelo;
    public ArrayList<Area> areas;
    
    public NewAreaForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTextLogin.setText("Crear Áreas");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        JOptionPane.showMessageDialog(this,"Áreas agregadas.", "Confirmación",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewAreaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewAreaForm dialog = new NewAreaForm(new javax.swing.JFrame(), true);
